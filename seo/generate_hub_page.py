...
{links_html}          </div>
    ...
    jsonld = json.dumps({
        ...
        "@type": "ItemList",
        "name": "業種別AIサービス活用ガイド",
        "description": "82業種それぞれに最適なAIサービスの活用方法を解説",
...
<head>
  ...
  <title>業種別AIサービス活用ガイド｜82業種対応 | 株式会社バンテックス</title>
  <meta name="description" content="美容室、飲食店、税理士事務所、不動産会社など82業種のAI活用方法を徹底解説。HP作成、SNS運用、集客、業務効率化、顧客対応の自動化まで、あなたの業種に最適なAIサービスが見つかります。">
  ...
  <meta property="og:title" content="業種別AIサービス活用ガイド｜82業種対応">
  <meta property="og:description" content="82業種それぞれに最適なAIサービスの活用方法を解説。HP作成、SNS運用、集客、業務効率化、顧客対応の自動化まで。">
  <meta property="og:site_name" content="株式会社バンテックス">
  <meta property="og:locale" content="ja_JP">

  <meta name="twitter:card" content="summary">
  <meta name="twitter:title" content="業種別AIサービス活用ガイド｜82業種対応 | バンテックス">
  <meta name="twitter:description" content="82業種のAI活用方法を徹底解説。あなたの業種に最適なAIサービスが見つかります。">
